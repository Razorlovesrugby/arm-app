    ...
    <div className="flex h-[100dvh] bg-gray-50">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 flex-shrink-0">
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          <p className="text-xs font-semibold text-brand-primary uppercase tracking-widest mb-0.5">
            ARM Enterprise
          </p>
        ...
        <div className="px-3 py-4 border-t border-gray-100">
          <div className="px-3 py-2 mb-1">
            ...
            <p className="text-xs font-medium text-brand-primary mt-0.5">Rugby Development Officer</p>
          </div>
          <button
            onClick={signOut}
